      ...
      <div className="flex flex-col lg:flex-row items-start justify-between max-w-6xl mx-auto p-6 gap-12 lg:gap-20">
        ...
        <div className="lg:text-left text-center order-1 lg:order-2 max-w-xl flex-1">
          ...
          <p className="text-lg leading-7 mb-5 text-gray-200">
            I'm Gayanga Bandara, a final-year B.Sc. Software Engineering undergraduate passionate about creating intuitive and impactful digital experiences. I specialize in Full-Stack Development and enjoy exploring modern technologies that make applications smarter, faster, and more user-friendly.
          </p>
          ...
          <div>
            ...
            <div className="flex items-center gap-5 mt-4 lg:justify-start justify-center">
              ...
              <a href="https://linkedin.com/in/gayangabandara" aria-label="LinkedIn" className="flex items-center justify-center size-12 rounded-full bg-white/5 hover:bg-blue-500/20 text-gray-300 hover:text-blue-400 transition-all duration-300 border border-white/10">
              ...
              <a href="mailto:gr.gayangabandara@gmail.com" aria-label="Gmail" className="flex items-center justify-center size-12 rounded-full bg-white/5 hover:bg-red-500/20 text-gray-300 hover:text-red-400 transition-all duration-300 border border-white/10">
